...
def results_to_csv(season, player_name, age, market_value, team_left, team_joined, transfer_fee):
    ...
    # filename = r"Datasets for Merging/transfer_data_dataset1.csv"
    filename = r"transfer_data_dataset.csv"
...
def transfer_scrapper(driver):
    ...
    # Choose seasons
    seasons_of_interest = ["14/15", "15/16", "16/17", "17/18", "18/19", "19/20", "20/21", "21/22", "22/23"]
